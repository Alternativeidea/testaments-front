    ...
    return (
        <>
                ...
                <div className='grid lg:grid-cols-2 gap-6'>
                    <div className={cn(
                        ...
                        <ul>
                            ...
                            <li><span className='font-medium'>Provizija 2. nivoja (Nivo 2):</span> provizija iz realiziranih poslov, ki jih opravijo člani, vpisani v strukturo v 2. nivoju pod svetovalcem (jih v sistem pripeljejo njihovi direkti v 1. nivoju).</li>
                        </ul>
            ...
            <div className='w-full flex justify-center items-center gap-2 p-4 bg-[#FEFEFE]'>
                <Link href='/namizje/tst-svetovalec' className={buttonVariants({ className: 'w-full max-w-[400px]' })}>Nazaj</Link>
            </div>
        </>
    )
}
