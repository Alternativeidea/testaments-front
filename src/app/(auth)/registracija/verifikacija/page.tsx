...
export default function SignInVerificationPage({ searchParams }: SignInVerificationPageProps) {
    return (
        <div className="mx-auto flex w-full h-full max-w-[627px] flex-col justify-center space-y-6 py-2 lg:py-0">
            ...
            <div className='flex flex-col gap-6 md:gap-12'>
                ...
                <div className='flex flex-col items-center [&_p]:text-center'>
                    ...
                    <p className='font-medium !text-body-big-2 text-primary-dark-gray mb-4'>{
                        searchParams.email
                    }</p>
