...
import { getMembershipsDataByUser } from '@/lib/services/ambassadors'
import { formatDate } from '@/lib/utils/date'
import { format } from 'date-fns'
import { ProvizijeColumns } from './provizije-columns'

export function ProvizijeAdmin({ userId }: {userId : number}) {
    ...
    useEffect(() => {
        const fetchData = async () => {
            setIsLoading(true)
            const data = await getMembershipsDataByUser(userId,
