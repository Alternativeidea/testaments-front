...
interface ChangeEmailLayoutProps {
    children: React.ReactNode
}

export default function ChangeEmailLayout({ children }: ChangeEmailLayoutProps) {
    return (
        <main>
            <div className="container relative grid min-h-screen flex-col items-center overflow-hidden bg-primary-dark-gray px-0 lg:max-w-none lg:!grid-cols-3">
                <div className="text-white relative flex h-full max-h-[328px] flex-col px-16 py-10 dark:border-r lg:mt-48 lg:max-h-full">
                    ...
                    <div className='relative flex w-full flex-col justify-center gap-6'>
                        <span className='text-center font-baskerville text-h4 text-primary-white lg:text-left lg:text-h3'>Spremenite e-mail</span>
                        <div className='flex flex-col gap-2'>
                            <span className='text-center text-body-medium font-bold text-gradient-gold lg:text-left'>VPIŠITE NOVI E-MAIL</span>
                            <span className='text-center text-body-medium text-primary-light-gray lg:text-left'>Vaš email bo uporabljen za dostopanje do računa</span>
                        </div>
                    </div>
                </div>
