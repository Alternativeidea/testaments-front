...
import { TransactionIcon } from '../../testaments/transaction-icon'
...
import UserTransactionDetails from '../users/tst/user-transaction-details'
...
export default function TstTransactionsCards({ data, className, limit }: TransactionsAccordionProps) {
...
function MobileRow({ id, user, type, status, quantity, rate, createdAt, updatedAt, reference, toUserId, to, cuId }: TransactionProps) {
    return (
...
function DesktopRow({ id, user, type, status, quantity, rate, createdAt, updatedAt, reference, toUserId, to, cuId }: TransactionProps) {
    return (
        <MovementRow>
            <MovementRowItem className='justify-start items-center min-w-[220px] gap-x-6'>
                <MovementIcon icon={
                    <TransactionIcon
                        status={status.toString()}
                        type={type.toString()}
            ...
            <MovementRowItem className='justify-start items-center w-[180px] overflow-hidden text-ellipsis line-clamp-1'>
