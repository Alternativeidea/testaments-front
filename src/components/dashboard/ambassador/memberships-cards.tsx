...
export async function MembershipsCards() {
            ...
            <div className='space-y-2'>
                ...
                <div className="w-full flex gap-4 overflow-x-auto no-scrollbar">
                    <div className='flex gap-x-2 min-w-full'>
                        ...
                        {/* <Card className='flex w-full border-0 bg-primary-light-gray/30 min-w-60 lg:min-w-fit'>
                            <CardHeader className='py-10 space-y-4'>
                                <CardTitle className='font-baskerville text-h6 font-normal'>{withCommas(dOporoke).replaceAll('.', ',')}<span className="text-body-small">  EUR</span></CardTitle>
                                <span className='font-bold text-body-small'>OPOROKE</span>
                            </CardHeader>
                        </Card> */}
                        <Card className='flex w-full border-0 bg-primary-light-gray/30 min-w-60 lg:min-w-fit'>
                            <CardHeader className='py-10 space-y-4'>
                        ...
                        {/* <Card className='flex w-full border-0 bg-primary-light-gray/30 min-w-60 lg:min-w-fit'>
                            <CardHeader className='py-10 space-y-4'>
                                <CardTitle className='font-baskerville text-h6 font-normal'>{withCommas(dTrznica).replaceAll('.', ',')}<span className="text-body-small">  EUR</span></CardTitle>
                                <span className='font-bold text-body-small'>TRŽNICA</span>
                            </CardHeader>
                        </Card> */}
                    </div>
                </div>
            ...
            <div className='space-y-2'>
                ...
                <div className="w-full flex gap-4 overflow-x-auto no-scrollbar">
                    <div className='flex gap-x-2 min-w-full'>
                        ...
                        {/* <Card className='flex w-full border-0 bg-primary-light-gray/30 min-w-60 lg:min-w-fit'>
                            <CardHeader className='py-10 space-y-4'>
                                <CardTitle className='font-baskerville text-h6 font-normal'>{withCommas(pOporoke).replaceAll('.', ',')}<span className="text-body-small">  EUR</span></CardTitle>
                                <span className='font-bold text-body-small'>OPOROKE</span>
                            </CardHeader>
                        </Card> */}
                        <Card className='flex w-full border-0 bg-primary-light-gray/30 min-w-60 lg:min-w-fit'>
                        ...
                        {/* <Card className='flex w-full border-0 bg-primary-light-gray/30 min-w-60 lg:min-w-fit'>
                            <CardHeader className='py-10 space-y-4'>
                                <CardTitle className='font-baskerville text-h6 font-normal'>{withCommas(pTrznica).replaceAll('.', ',')}<span className="text-body-small">  EUR</span></CardTitle>
                                <span className='font-bold text-body-small'>TRŽNICA</span>
                            </CardHeader>
                        </Card> */}
                    </div>
