...
export default function SignInVerificationOverduePage() {
    return (
        <div className="mx-auto flex w-full h-full max-w-[627px] flex-col justify-center space-y-6 py-2 lg:py-0">
            ...
            <div className='flex flex-col gap-6'>
                <Link href='/' className="relative z-20 w-fit flex items-center gap-4 justify-center mx-auto">
                    <Ilustrations.Time className='w-full max-w-24 lg:max-w-40 h-[95px] lg:h-[145px] text-primary-dark-gray' />
                </Link>
                <div className='flex flex-col items-center [&_p]:text-center'>
                    <h1 className='text-h5 font-baskerville text-center mb-4 lg:mb-9'>Verifikacijski link je potekel</h1>
